...
public partial class GreenSlime_MoveControlState : State
{
	...
	// mid-jump horizontal lock: when slime reaches a fraction of its ascent, lock horizontal speed
	[Export] private float _midJumpLockFraction = 0.5f; // fraction of initial upward speed when to lock (0..1)
